    ...
    <div class="container mt-5">
        <div class="row content">
            <table class="table-bordered text-center">
                ...
                <tr>
                    <td colspan="4"><img src="<?= base_url('assets/rps/logoamikomrps.png'); ?>" width="300"></td>
                </tr>
                <tr>
                    <td colspan="4">
                ...
                <tr>
                    <td><img src="<?php echo site_url('assets/rps/ttd.jpg'); ?>" alt="" width="100px" height="100px"></td>
                    <td><img src="<?php echo site_url('assets/rps/ttd.jpg'); ?>" alt="" width="100px" height="100px"></td>
                    <td><img src="<?php echo site_url('assets/rps/ttd.jpg'); ?>" alt="" width="100px" height="100px"></td>
                    <td><img src="<?php echo site_url('assets/rps/ttd.jpg'); ?>" alt="" width="100px" height="100px"></td>
                </tr>
            ...
            <div class="p-0 mt-4">
                <table class="table text-center table-bordered border border-secondary">
                    <tr>
                        <td rowspan="2">
                            <img src="<?= base_url('assets/rps/logoamikomrps.png'); ?>" width="200" class="my-5">
                        </td>
                        <td rowspan="2">
            ...
            <div class="container-fluid">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td colspan="2">Firman Asharudin, M.Kom</i></td>
                    </tr>
                        ...
                        <table class="table table-bordered" id="table">
                            <thead>
                                <tr class="text-center">
                                    ...
                                    <th scope="col">Kemampuan Akhir yang Diharapkan</th>
                                    <th scope="col">Indikator</th>
                                    <th scope="col">Topik dan Sub Topik</th>
        ...
        <div>
            <div class="d-grid gap-2 d-md-flex justify-content-md-end d-print-none">
                <a href="<?= base_url('user') ?>" class="btn btn-secondary navbar-btn d-print-none">Kembali</a>
